#define HAZARD_INPUT A0
#define LEFT_SIGNAL_INPUT A1
#define RIGHT_SIGNAL_INPUT A2
#define LOW_BEAM_INPUT A3
#define BRAKE_INPUT A4


#define DRIVER_LOW_BEAM_OUTPUT 9
#define DRIVER_FRONT_SIGNAL_OUTPUT 10
#define PASS_LOW_BEAM_OUTPUT 11
#define PASS_FRONT_SIGNAL_OUTPUT 12

#define DRIVER_SOLID_OUTPUT 5
#define DRIVER_FLASHING_OUTPUT 6
#define PASS_SOLID_OUTPUT 7
#define PASS_FLASHING_OUTPUT 8
